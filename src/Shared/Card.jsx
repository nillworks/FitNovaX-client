      ...
      <div className="flex flex-col flex-grow p-6 md:p-8">
        ...
        <div className="flex items-center space-x-3 mb-6">
          <div className="w-10 h-10 rounded-full bg-[#C6F4D6] flex items-center justify-center flex-shrink-0 border border-[#8FE3B0]">
            <span className="text-[#15803D] font-bold text-sm">{trainerName.charAt(0)}</span>
          </div>
          <div>
            <p className="text-[#64748B] text-xs font-semibold uppercase tracking-tight">Trainer</p>
        ...
        <div className="flex items-center justify-between mt-auto pt-5 border-t border-[#E2E8F0]">
          <div className="flex flex-col">
            <span className="text-[#64748B] text-xs font-semibold uppercase tracking-tight">Session Price</span>
            <span className="text-xl font-bold text-[#1E293B] leading-relaxed">{price}</span>
          </div>
          <div className="flex flex-col text-right">
             <span className="text-[#64748B] text-xs font-semibold uppercase tracking-tight">Bookings</span>
             <div className="flex items-center space-x-1 justify-end">
               <svg className="w-4 h-4 text-[#22C55E]" fill="currentColor" viewBox="0 0 20 20">
                 <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
               </svg>
               <span className="text-sm font-bold text-[#1E293B]">{bookingCount}</span>
             </div>
          </div>
        </div>

        <div className="mt-6">
          <button className="w-full py-3.5 px-6 rounded-full bg-[#22C55E] hover:bg-[#16A34A] text-[#FFFFFF] font-bold tracking-tight transition-all duration-300 shadow-sm hover:shadow-md active:scale-95 flex justify-center items-center space-x-2">
