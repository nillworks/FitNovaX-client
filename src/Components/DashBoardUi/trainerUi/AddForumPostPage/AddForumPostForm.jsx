...
const AddForumPostForm = ({ categories, tags }) => {
  ...
  const handleForumDataSubmit = async (e) => {
    ...
    try {
      ...
      console.log("forum data submitted", NewForumData);
    ...
    <form className="space-y-6 md:space-y-8" onSubmit={handleForumDataSubmit}>
      ...
      <div className="bg-[#FFFFFF] rounded-3xl border border-[#E2E8F0] p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
        <h2 className="text-2xl font-bold text-[#1E293B] mb-6 flex items-center gap-3">
          <span className="bg-[#C6F4D6] text-[#15803D] w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold shadow-sm">1</span>
          Post Basics
        </h2>
        
        <div className="space-y-6">
          <div>
            <label className="block text-sm font-bold text-[#1E293B] mb-2 tracking-tight">Post Title <span className="text-[#DC2626]">*</span></label>
            <input 
              type="text" 
              required
              value={title}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-bold text-[#1E293B] mb-2 tracking-tight">Category <span className="text-[#DC2626]">*</span></label>
            ...
            <div>
              <label className="block text-sm font-bold text-[#1E293B] mb-2 tracking-tight">Tags <span className="text-[#DC2626]">*</span></label>
      ...
      <div className="bg-[#FFFFFF] rounded-3xl border border-[#E2E8F0] p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
        <h2 className="text-2xl font-bold text-[#1E293B] mb-6 flex items-center gap-3">
          <span className="bg-[#C6F4D6] text-[#15803D] w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold shadow-sm">2</span>
          Cover Image
        </h2>
        ...
        >
          ...
          {imagePreview ? (
            ...
            <>
              ...
              <h3 className="text-xl font-bold text-[#1E293B] mb-2">Upload your cover image</h3>
              <p className="text-[#64748B] text-sm font-medium mb-6">PNG, JPG, WebP up to 5MB</p>
              <button type="button" className="bg-white border border-[#E2E8F0] text-[#1E293B] px-8 py-3 rounded-full font-bold transition-all duration-300 shadow-sm pointer-events-none">
                Browse Files
              </button>
            </>
          )}
      ...
      <div className="bg-[#FFFFFF] rounded-3xl border border-[#E2E8F0] p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
        <h2 className="text-2xl font-bold text-[#1E293B] mb-6 flex items-center gap-3">
          <span className="bg-[#C6F4D6] text-[#15803D] w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold shadow-sm">3</span>
          Content Details
        </h2>
        ...
        <div className="space-y-8">
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="block text-sm font-bold text-[#1E293B] tracking-tight">Short Summary <span className="text-[#DC2626]">*</span></label>
              <span className={`text-xs font-bold px-2 py-1 rounded-md ${summaryLength > 150 ? 'bg-red-100 text-red-600' : 'bg-[#F8FAFC] text-[#64748B]'}`}>
                {summaryLength} / 150
              </span>
            </div>
            <textarea 
          ...
          <div>
            <label className="block text-sm font-bold text-[#1E293B] mb-2 tracking-tight">Description <span className="text-[#DC2626]">*</span></label>
            <div className="border border-[#E2E8F0] rounded-2xl overflow-hidden focus-within:border-[#22C55E] focus-within:ring-1 focus-within:ring-[#22C55E] transition-all duration-300 shadow-sm">
              ...
              <div className="bg-[#F8FAFC] border-b border-[#E2E8F0] px-4 py-3 flex gap-2 overflow-x-auto custom-scrollbar">
                <button type="button" className="p-2 text-[#64748B] hover:text-[#1E293B] hover:bg-[#E2E8F0] rounded-xl transition-colors font-bold w-10 h-10 flex items-center justify-center cursor-pointer">B</button>
                <button type="button" className="p-2 text-[#64748B] hover:text-[#1E293B] hover:bg-[#E2E8F0] rounded-xl transition-colors italic font-serif w-10 h-10 flex items-center justify-center cursor-pointer">I</button>
                <button type="button" className="p-2 text-[#64748B] hover:text-[#1E293B] hover:bg-[#E2E8F0] rounded-xl transition-colors underline w-10 h-10 flex items-center justify-center cursor-pointer">U</button>
                <div className="w-px h-6 bg-[#E2E8F0] my-auto mx-2"></div>
                <button type="button" className="p-2 text-[#64748B] hover:text-[#1E293B] hover:bg-[#E2E8F0] rounded-xl transition-colors w-10 h-10 flex items-center justify-center cursor-pointer"><FileText className="w-4 h-4" /></button>
              </div>
              <textarea 
                rows="12"
                required
      ...
      <div className="bg-[#FFFFFF] rounded-3xl border border-[#E2E8F0] p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
        <h2 className="text-2xl font-bold text-[#1E293B] mb-6 flex items-center gap-3">
          <span className="bg-[#C6F4D6] text-[#15803D] w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold shadow-sm">4</span>
          Publishing Settings
        </h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          <div>
            <label className="block text-sm font-bold text-[#1E293B] mb-2 tracking-tight">Reading Time <span className="text-[#DC2626]">*</span></label>
            <div className="relative">
              <input 
                type="number" 
                required
              ...
              />
              <span className="absolute right-5 top-1/2 -translate-y-1/2 bg-[#E2E8F0] text-[#64748B] px-3 py-1 rounded-lg font-bold text-xs">min read</span>
            </div>
          </div>

          <div>
             <label className="block text-sm font-bold text-[#1E293B] mb-2 tracking-tight">Featured Post</label>
             <div 
             ...
             >
                <div className="flex flex-col">
                  <span className={`font-bold ${isFeatured ? 'text-[#15803D]' : 'text-[#1E293B]'}`}>Pin to Top</span>
                  <span className="text-xs font-medium text-[#64748B] mt-0.5">Show this post on the featured slider</span>
                </div>
                <div className={`relative w-14 h-7 rounded-full transition-colors duration-300 shadow-inner ${isFeatured ? 'bg-[#22C55E]' : 'bg-[#E2E8F0]'}`}>
                  <div className={`absolute top-1 w-5 h-5 rounded-full bg-white shadow-sm transition-transform duration-300 ${isFeatured ? 'left-8' : 'left-1'}`}></div>
                </div>
             </div>
          </div>
        </div>
      ...
      <div className="bg-transparent pt-4 flex flex-col sm:flex-row items-center justify-end gap-5">
        <button type="button" className="w-full sm:w-auto px-8 py-4 rounded-full font-bold text-[#1E293B] bg-white border border-[#E2E8F0] hover:border-[#8FE3B0] hover:bg-[#F8FAFC] hover:text-[#15803D] transition-all duration-300 shadow-sm cursor-pointer">
          Save Draft
        </button>
        <button 
          type="submit" 
